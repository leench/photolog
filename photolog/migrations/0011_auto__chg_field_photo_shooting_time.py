...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Photo.shooting_time'
        db.alter_column(u'photolog_photo', 'shooting_time', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Photo.shooting_time'
        db.alter_column(u'photolog_photo', 'shooting_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 7, 22, 0, 0)))
    ...
    models = {
        ...
        u'photolog.photo': {
            ...
            'shooting_time': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
